...
export type UserRole = "it_admin" | "boss" | "direktor" | "muhasib" | "menecer"
...
export function useUserRole() {
  ...
  return { profile, loading, isAdmin, isBoss, isDirektor, isMuhasib, canEdit, canDelete, canSeeFinances }
}